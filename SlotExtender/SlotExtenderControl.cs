...
{
    public class SlotExtenderControl : MonoBehaviour
    {
        public SlotExtenderControl Instance { get; private set; }
        ...
        {
            return Player.main && (Player.main.inSeamoth || Player.main.inExosuit);
        }
    }
}
